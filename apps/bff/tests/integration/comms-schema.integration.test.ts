 ...
 *
 *   pnpm --filter @tps/bff exec vitest run tests/integration/comms-schema.integration.test.ts
 *
...
import { assertCommsSchema, REQUIRED_COMMS_MIGRATION } from '../../src/commsDb.js';
