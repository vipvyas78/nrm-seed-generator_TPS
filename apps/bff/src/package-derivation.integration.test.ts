 ...
 *
 *   pnpm --filter @tps/bff exec vitest run src/package-derivation.integration.test.ts
 *
...
import { handleTakeoffTendered } from './queues.js';
import { ScmsReadDatabase } from './scmsReadDb.js';
import { takeoffTenderedMessage, type TakeoffTendered } from './takeoffCompletion.js';
