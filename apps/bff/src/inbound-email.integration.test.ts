 ...
 *
 *   pnpm --filter @tps/bff exec vitest run src/inbound-email.integration.test.ts
 *
...
import { inboundEmailPayload, subjectMarker, type InboundEmail } from './inboundEmail.js';
